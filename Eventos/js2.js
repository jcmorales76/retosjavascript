const personas = [
 ...
 /* for(const persona of personas){
    ...
    div.innerHTML = `<h4>Empleado : ${item.id}</h4>
...
btnRegistro.innerHTML = 'Boton de nucleo';
...
document.body.append(btnRegistro);



//   let btnRegistro = document.getElementById('btnRegistro');
//   btnRegistro.addEventListener("click",ingresoDatos);