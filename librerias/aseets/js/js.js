...
const ingresoDatos = () => {
  ...
  Swal.fire({
    position: 'center',
    icon: 'success',
    title: 'Se grabo al Storage Correctamente',
...
const verUsuarios =() => {
  ...
  Swal.fire({
    position: 'center',
    icon: 'success',
    title: 'Lista de personas general',
    showConfirmButton: false,
    timer: 1500
  })
};
...
const cambiarTipoUsuario = (nombre, _apellido, tipoUsuario) => {
 ...
 personas.tipoUsuario = tipoUsuario;
...
btnVerUsuarios.addEventListener(evento,verUsuarios);
